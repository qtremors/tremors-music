        ...
        <div className="relative z-10 flex items-end gap-8 w-full">
          ...
          <div className="flex gap-3 mb-2">
            ...
            <button
              ...
              className="w-14 h-14 rounded-full bg-gray-200 dark:bg-white/10 text-apple-text flex items-center justify-center shadow-lg hover:scale-105 transition"
              title="Shuffle Album"
            >
              <Shuffle size={24} />
            </button>
          ...
          {songs?.map((song, index) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "flex items-center px-4 py-3 rounded-lg cursor-pointer group/row transition-colors hover:bg-gray-200/50 dark:hover:bg-white/5",
