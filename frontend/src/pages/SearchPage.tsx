...
export function SearchPage() {
  ...
  // Note: Using explicit type assertions in JSX since TS doesn't narrow properly in conditional renders
  let topResult: Song | Album | { name: string } | null = null;
          ...
          <div className="space-y-8">
            ...
            {topResult && (
              <div>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm text-apple-subtext">{formatTime(song.duration)}</span>
                        </div>
                      </div>
                    </div>
                  );
                ...
                {/* Album Top Result */}
                {topResultType === 'album' && (() => {
                  const album = topResult as Album;
                  return (
                    <div
                ...
                {/* Artist Top Result */}
                {topResultType === 'artist' && (() => {
                  const artist = topResult as { name: string };
                  return (
                    <div
                      className="flex items-center gap-6 p-6 rounded-xl bg-gradient-to-br from-apple-accent/10 to-transparent hover:from-apple-accent/20 cursor-pointer group transition-all border border-apple-accent/20"
