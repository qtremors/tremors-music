...
function AlbumSection({
    ...
    group: { album: Album | null; songs: Song[] };
    idx: number;
                ...
                {(group.songs || []).map((song) => {
                    ...
                    return (
                        <div
                            ...
                            className={cn(
                                "flex items-center px-4 py-3 rounded-lg cursor-pointer group/row transition-colors hover:bg-gray-200/50 dark:hover:bg-white/5 border-b border-gray-100 dark:border-white/5 last:border-0",
