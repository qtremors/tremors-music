...
import { Play, Trash2, Music, ListMusic } from 'lucide-react';
    ...
    <div className="h-full flex flex-col bg-apple-gray overflow-hidden">
      ...
      <div className="p-8 pb-6 flex items-end gap-6 border-b border-gray-200 dark:border-white/10 flex-shrink-0 bg-apple-gray z-10">
        ...
        <div className="flex-1 mb-1">
            ...
            <div className="flex items-center gap-4 text-apple-subtext text-sm font-medium">
                <span>{songs?.length || 0} Songs</span>
                {songs && songs.length > 0 && (
                    <button 
                        onClick={() => handlePlay(songs[0])}
                        className="flex items-center gap-2 text-apple-accent hover:underline"
                    >
